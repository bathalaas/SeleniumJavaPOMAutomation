...
public class TC0022_WorkAssignment_CallLogVerification extends PcorpWrappers {
	...
	public void login(String emailid, String password, String breadcrumbs1, String breadcrumbs2, String breadcrumbs3,
		...
		new LoginPage().enterUsername(emailid).enterPassword(password)
		.clickLoginButton()
		.clickHumburger()
		.clickMenu3()
		.clickMenu30()
	...
	public void beforeClass() {
		...
		testCaseName = "WA_CallLog Verification";
